...
#### Fully supported "out of the box" languages (with simplify writing on the "main" modification)
...
#### Полностью поддерживаемые языки "из коробки" (с упрощённым вводом на основной модификации)
